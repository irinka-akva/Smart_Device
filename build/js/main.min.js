...
var getSwitcherList = function getSwitcherList() {
  if (window.innerWidth <= 767) {
    openElements.forEach(function (openElement) {
      var accordionActiveItems = openElement.querySelector('.footer__contacts-list-link');
      accordionActiveItems.forEach(function (activeItem) {
        activeItem.setAttribute('tabindex', '0');
      });
    });
    closeElements.forEach(function (closeElement) {
      var accordionClosedItems = closeElement.querySelector('.footer__contacts-list-link');
      accordionClosedItems.forEach(function (closedItems) {
