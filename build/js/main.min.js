...
var accordionElements = document.querySelectorAll('[data-accordion="element"]');
var activeElements = accordionElements.classList.contains('is-active');
...
var getSwitcherList = function getSwitcherList() {
  if (window.innerWidth <= 767) {
    if (activeElements !== 'undefined') {
      activeElements.document.querySelectorAll('.footer__contacts-list-link').forEach(function (element) {
