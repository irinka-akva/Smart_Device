...
/* harmony import */ var _modules_accordion_accordions_switcher__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/accordion/accordions-switcher */ "./js/modules/accordion/accordions-switcher.js");
/* harmony import */ var _modules_show_more__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/show-more */ "./js/modules/show-more.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_header_scroll__WEBPACK_IMPORTED_MODULE_3__["scrollAddHandler"])();
    Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])();
    Object(_modules_show_more__WEBPACK_IMPORTED_MODULE_6__["extraTextOpenAndCloseHandler"])();
    var form = new _modules_form_validate_form__WEBPACK_IMPORTED_MODULE_2__["Form"]();
    window.form = form;
    form.init();
    Object(_modules_accordion_accordions_switcher__WEBPACK_IMPORTED_MODULE_5__["buttonSwitchHandler"])();
    Object(_modules_accordion_accordions_switcher__WEBPACK_IMPORTED_MODULE_5__["accordionSwitchHandler"])();
  });
});
...
/*!*****************************************************!*\
  !*** ./js/modules/accordion/accordions-switcher.js ***!
  \*****************************************************/
/*! exports provided: buttonSwitchHandler, accordionSwitchHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "buttonSwitchHandler", function() { return buttonSwitchHandler; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "accordionSwitchHandler", function() { return accordionSwitchHandler; });
var accordionButtons = document.querySelectorAll('[data-accordion="button"]');
var openElement = document.getElementsByClassName('accordion__element is-active');
var accordionLinks = document.querySelectorAll('[data-accordion="element-link"]');

// настройка переключения заголовков аккордеона по Tab

var getSwitcherButton = function getSwitcherButton() {
...
var buttonSwitchHandler = function buttonSwitchHandler() {
  window.addEventListener('keydown', getSwitcherButton);
};

// настройка переключения списка аккордеона по Tab

var getSwitcherList = function getSwitcherList() {
  if (window.innerWidth <= 767) {
    accordionLinks.forEach(function (activeItem) {
      activeItem.setAttribute('tabindex', '-1');
    });
    if (openElement.length !== 0) {
      var openElementArray = Array.from(openElement);
      var accordionActiveItems = openElementArray[0].querySelectorAll('[data-accordion="element-link"]');
      accordionActiveItems.forEach(function (activeItem) {
...
var accordionSwitchHandler = function accordionSwitchHandler() {
  accordionButtons.forEach(function (element) {
...
/*!*************************************!*\
  !*** ./js/modules/header-scroll.js ***!
  \*************************************/
/*! exports provided: scrollAddHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scrollAddHandler", function() { return scrollAddHandler; });
...
var scrollAddHandler = function scrollAddHandler() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "extraTextOpenAndCloseHandler", function() { return extraTextOpenAndCloseHandler; });
var moreText = document.querySelector('[data-show-more="more-text"]');
var moreTextMobile = document.querySelector('[data-show-more="more-text-mobile"]');
var buttonMore = document.querySelector('[data-show-more="button-more"]');
...
var extraTextOpenAndCloseHandler = function extraTextOpenAndCloseHandler() {
